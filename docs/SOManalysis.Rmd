...
params <- read_csv(here("Data", "somParams", "params_SOM.csv"))
...
Here are the top  runs based on npF
...
##### Choose the best run from each high performing cluster #
...
```{r boxplots, include = TRUE, echo = FALSE, message = FALSE, warning = FALSE, fig.asp = 1.4}
...
#### Examine how the clusters map on to the cumulative runoff curves
```{r, include = TRUE, echo = FALSE, message = FALSE, warning = FALSE, fig.asp = 1, out.width = "80%"}
datWithCluster %>% 
